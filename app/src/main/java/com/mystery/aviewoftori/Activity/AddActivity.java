...
import com.mystery.aviewoftori.Other.TimeDatePickerDialog;
...
public class AddActivity extends AppCompatActivity implements TimeDatePickerDialog.TimeDatePickerDialogInterface {
    ...
    private void openCamera() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            imageUri = FileProvider.getUriForFile(AddActivity.this, "com.mystery.aviewoftori.fileprovider", storeImage);
